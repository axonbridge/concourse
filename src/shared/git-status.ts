// Git status/diff result types + pure parsers for the server git service
// (src/server/services/git.ts). Single source of truth for the wire contract
// the host's GitDiffView consumes.
